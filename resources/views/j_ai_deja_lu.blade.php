...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/a-lire-plus-tard.css') }}" />
  ...
  <body style="margin: 0; background: #ffffff">
    <input type="hidden" id="anPageName" name="page" value="a-lire-plus-tard" />
    <div class="container-center-horizontal">
      <div class="a-lire-plus-tard screen">
        <div class="page">
          <!-- <div class="sidebar">
            <div class="flex-col">
              ...
              <div class="menu">
                ...
                <div class="dj-vu">
                  <img class="sitemap-1" src="{{ asset('public/img/sitemap-1-88@2x.png') }}" alt="sitemap 1" />
              ...
              <div class="nouvelle-section-recherche">
                <div class="recherche-section">
                  ...
                  <div class="barre-de-recherche">
                    <form action="{{asset('/')}}search_read_already" method="POST" name="search_read_already" id="search_read_already">
                      @csrf
                    <img class="bxsearch-alt" src="{{ asset('public/img/bx-search-alt-6@2x.png') }}" alt="bx:search-alt" />
                    <div class="mot-cls"><div class=""><input type="text" id="search_text" value="" name="search_text" placeholder="écrire le titre ou la description des articles ici" style="width:800px;border:1px solid black;" /></div>
                    </div>
                  </div>
                  <div class="filtre">
                  ...
                  <form action="{{asset('/')}}create_newsletter" method="POST" name="create_newsletter" id="create_newsletter">
                    ...
                    <input type="hidden" name="pagename" id="pagename" value="j_ai_deja_lu">
                  </form>
                  ...
                  <div class="cta">
                    <div class="call-to-action recherche"  style="cursor: pointer;">
                      <div class="pesquisar valign-text-middle roboto-bold-white-16px">
                        <span>
                          <span class="roboto-bold-white-16px">
                           Recherche
                          </span>
                        </span>
                      </div>
                ...
                @foreach ($articles as $key =>$data)
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ asset('public/img/logo-109@2x.png') }}" alt="logo" />
                        <div class="frame-1291">
                          ...
                          <div class="group-1291">
                            <p class="lorem-ipsum-dolor-si archivo-normal-black-pearl-13px">
                              <span class="archivo-normal-black-pearl-13px">{{ $data->description }}</span>
                              <span class="readmore">
                            ...
                            <div class="icone-article">
                              <div class="interation">
                                ...
                                @endif
                                @if($data->u_unread>0)
                                <img class="a-lire-plus-tard-1" src="https://icons.iconarchive.com/icons/icons8/ios7/24/Programming-Show-Property-icon.png"
                                  alt="a lire plus tard" />
                                @else
                                <img class="a-lire-plus-tard-1" id="ptard{{$data->id}}" onClick='mark_unread("{{$data->id}}")' src="{{ asset('public/img/a-lire-plus-tard-82@2x.png') }}"
                                  alt="a lire plus tard" />
                                @endif
                              </div>
                  ...
                  <!-- <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo-1" src="{{ asset('public/img/logo-110@2x.png') }}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                          ...
                          <div class="group-1291">
                            ...
                            <div class="icone-article">
                              <div class="interation">
                                <img class="urgent" src="{{ asset('public/img/urgent-74@2x.png') }}" alt="urgent" />
                                <div class="like">
                                  <img class="vector" src="{{ asset('public/img/vector-87@2x.png') }}" alt="Vector" />
                                  <div class="number archivo-light-indigo-17px">
                                    <span class="archivo-light-indigo-17px">3</span>
                                  </div>
                                </div>
                                <img class="dj-lu" src="{{ asset('public/img/d-j--lu-82@2x.png') }}" alt="dj lu" />
                                <img
                                  class="a-lire-plus-tard-1"
                                  src="{{ asset('public/img/a-lire-plus-tard-82@2x.png') }}"
                                  alt="a lire plus tard"
                                />
                              </div>
                              <img class="partage" src="{{ asset('public/img/partage-35@2x.png') }}" alt="Partage" />
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ asset('public/img/logo-111@2x.png') }}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                ...
                <!-- <div class="frame-117">
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ asset('public/img/logo-55@2x.png') }}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo-1" src="{{ asset('public/img/logo-77@2x.png') }}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo-1" src="{{ asset('public/img/logo-80@2x.png') }}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                ...
                <div class="frame-117">
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ asset('public/img/logo-56@2x.png') }}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ asset('public/img/logo-117@2x.png') }}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
