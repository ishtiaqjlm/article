                ...
                <div class="catgories-dtails">
                    ...
                    <div class="frame-1-1">
                      ...
                      <a href="{{ asset('/category') }}/{{$data->id}}">
                       ...
                       @endforeach
                      <div class="nav-bar-produit">
                        <!-- <div class="frame">
                          <div class="etiquetage archivo-normal-manatee-12px">
                            <span class="archivo-normal-manatee-12px">Etiquetage</span>
                          </div>
                        </div> -->
                       <!--  <a href="{{ asset('/category_alcool') }}">
                        <div class="frame">
                          <div class="alcool archivo-normal-manatee-12px">
                            <span class="archivo-normal-manatee-12px">Alcool</span>
                          </div>
                        </div>
                        </a> -->
                        <!-- <div class="frame">
                          <div class="novel-food archivo-normal-manatee-12px">
                            <span class="archivo-normal-manatee-12px">Novel Food</span>
                          </div>
                        </div>
                        <div class="frame-5">
                          <div class="ingrdients-fonctionnels archivo-bold-scarlet-gum-12px">
                            <span class="archivo-bold-scarlet-gum-12px">Ingrédients fonctionnels</span>
                          </div>
                        </div>
                        <div class="frame-7">
                          <div class="protines-alternatives archivo-normal-manatee-12px">
                            <span class="archivo-normal-manatee-12px"> Protéines alternatives</span>
                          </div>
                        </div>
                        <div class="frame-10">
                          <div class="complments-alimentaires archivo-normal-manatee-12px">
                            <span class="archivo-normal-manatee-12px">Compléments alimentaires</span>
                          </div>
                        </div>
                        <div class="frame-1">
                          <div class="cosmtiques archivo-normal-manatee-12px">
                            <span class="archivo-normal-manatee-12px">Cosmétiques</span>
                          </div>
                        </div>
                        <div class="frame-1">
                          <div class="cbd-chanvre archivo-normal-manatee-12px">
                            <span class="archivo-normal-manatee-12px">CBD/Chanvre</span>
                          </div>
                        </div> -->
                      </div>
                      <!-- <div class="stream">
