@include('header')
  <body style="margin: 0; background: #ffffff">
    <input type="hidden" id="anPageName" name="page" value="a-lire-plus-tard-1" />
    <div class="container-center-horizontal">
      <div class="a-lire-plus-tard-1 screen">
        <div class="page">
          <div class="sidebar">
            <div class="flex-col">
              <div class="component-1">
                <img class="rectangle-1170" src="{{ URL::asset('img/rectangle-1170-13@2x.png');}}" alt="Rectangle 1170" />
                <div class="overlap-group1-1">
                  <img class="collapse" src="{{ URL::asset('img/collapse-13@2x.png');}}" alt="Collapse" />
              ...
              <div class="menu">
                <div class="accueil">
                  <img class="x-alt-1" src="{{ URL::asset('img/home-alt-1-12@2x.png');}}" alt="home-alt 1" />
                ...
                <div class="overlap-group-3">
                  <img class="apps-1" src="{{ URL::asset('img/apps-1-3@2x.png');}}" alt="apps 1" />
                ...
                <div class="urgent-cab">
                  <img class="sitemap-1-1" src="{{ URL::asset('img/sitemap-1-3@2x.png');}}" alt="sitemap 1" />
                ...
                <div class="liker">
                  <img class="sitemap-1-2" src="{{ URL::asset('img/sitemap-1-4@2x.png');}}" alt="sitemap 1" />
                ...
                <div class="je-lis-plus-tard">
                  <div class="sitemap-1-3">
                    <img class="iconbookshelf" src="{{ URL::asset('img/icon-bookshelf-1@2x.png');}}" alt="icon/bookshelf" />
                  </div>
                ...
                <div class="dj-vu">
                  <img class="sitemap-1" src="{{ URL::asset('img/sitemap-1-88@2x.png');}}" alt="sitemap 1" />
                  <div class="jai-dj-lu valign-text-middle archivo-bold-scarlet-gum-16px">
                    <span><span class="archivo-bold-scarlet-gum-16px">J&#39;ai déjà lu</span> </span>
                  </div>
                </div>
                <div class="dj-vu-1">
                  <img class="sitemap-1" src="{{ URL::asset('img/sitemap-2-4@2x.png');}}" alt="sitemap 1" />
                ...
                <div class="newsletter">
                  <img class="sitemap-1-4" src="{{ URL::asset('img/sitemap-1-2@2x.png');}}" alt="sitemap 1" />
                ...
                <div class="admin">
                  <img class="x-alt-1" src="{{ URL::asset('img/users-alt-1-11@2x.png');}}" alt="users-alt 1" />
                ...
                <div class="logout">
                  <img class="line-12" src="{{ URL::asset('img/line-12-1@2x.png');}}" alt="Line 12" />
                  <div class="flex-row">
                    <img class="vector-1" src="{{ URL::asset('img/vector-1@2x.png');}}" alt="Vector" />
            ...
            <img class="line-1" src="{{ URL::asset('img/line-1-16@2x.png');}}" alt="Line 1" />
          </div>
          <div class="contenue">
              ...
              <div class="overlap-group9">
                ...
                <div class="frame-1185">
                  <div class="catgories-3 roboto-medium-scarlet-gum-24px">
                    <span class="roboto-medium-scarlet-gum-24px">J&#39;ai déjà lu</span>
                  </div>
                  <div class="notification">
                    <div class="ellipse-94"></div>
                  </div>
                  <img class="cog-1" src="{{ URL::asset('img/cog-1-17@2x.png');}}" alt="cog 1" />
                  <img class="profile" src="{{ URL::asset('img/profile-1@2x.png');}}" alt="Profile" />
              ...
              <div class="section-recherche">
                <div class="recherche-section">
                  <div class="overlap-group-4">
                    ...
                    <img class="bxbx-help-circle" src="{{ URL::asset('img/bx-bx-help-circle-5@2x.png');}}" alt="bx:bx-help-circle" />
                  </div>
                  <div class="barre-de-recherche">
                    <img class="bxsearch-alt" src="{{ URL::asset('img/bx-search-alt-7@2x.png');}}" alt="bx:search-alt" />
                  ...
                  <div class="filtre">
                    ...
                    <div class="box">
                      <div class="date-1">
                        <img class="calendar52" src="{{ URL::asset('img/calendar52-11@2x.png');}}" alt="calendar52" />
                ...
                <div class="frame-117">
                    ...
                    <div class="overlap-group">
                      <div class="titre-et-date">
                        <div class="lorem-ipsum-dolor-sit valign-text-middle archivo-semi-bold-black-17px">
                          <span><span class="archivo-semi-bold-black-17px">Lorem ipsum dolor sit</span> </span>
                        </div>
                        <div class="date valign-text-middle archivo-normal-black-13px">
                          <span><span class="archivo-normal-black-13px">06/08/2022</span> </span>
                        </div>
                      </div>
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ URL::asset('img/logo-100@2x.png');}}" alt="logo" />
                          ...
                          <div class="group-1291">
                            <p class="lorem-ipsum-dolor-si archivo-normal-black-pearl-13px">
                              <span class="archivo-normal-black-pearl-13px"
                                >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Adipiscing viverra dignissim
                                hac a viverra in facilisis at dictumst&nbsp;&nbsp;viverra dignissim hac a viverra in
                                viverra dignissim hac a viverra in. .. ...</span
                              >
                            </p>
                            <div class="icone-article">
                              <div class="interation">
                                <img class="urgent" src="{{ URL::asset('img/urgent-74@2x.png');}}" alt="urgent" />
                                <div class="like">
                                  <img class="vector" src="{{ URL::asset('img/vector-87@2x.png');}}" alt="Vector" />
                                  <div class="number archivo-light-indigo-17px">
                                    <span class="archivo-light-indigo-17px">3</span>
                                  </div>
                                </div>
                                <img class="dj-lu" src="{{ URL::asset('img/d-j--lu-82@2x.png');}}" alt="dj lu" />
                                <img
                                  class="a-lire-plus-tard"
                                  src="{{ URL::asset('img/a-lire-plus-tard-82@2x.png');}}"
                                  alt="a lire plus tard"
                                />
                              </div>
                              <img class="partage" src="{{ URL::asset('img/partage-35@2x.png');}}" alt="Partage" />
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo-1" src="{{ URL::asset('img/logo-101@2x.png');}}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ URL::asset('img/logo-102@2x.png');}}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                ...
                <div class="frame-117">
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ URL::asset('img/logo-88@2x.png');}}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo-1" src="{{ URL::asset('img/logo-104@2x.png');}}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo-1" src="{{ URL::asset('img/logo-80@2x.png');}}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                ...
                <div class="frame-117">
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ URL::asset('img/logo-47@2x.png');}}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
                  ...
                  <div class="article-rcent-carte">
                    <div class="overlap-group">
                      ...
                      <div class="overlap-group-1">
                        <img class="logo" src="{{ URL::asset('img/logo-72@2x.png');}}" alt="logo" />
                        <div class="frame-1291">
                          <div class="catgories">
                            <div class="badge-catgorie">
                              <div class="overlap-group-2">
        ...
        <div class="footer">
          <div class="overlap-group10">
            ...
            <img class="rectangle-1193" src="{{ URL::asset('img/rectangle-1193-9@2x.png');}}" alt="Rectangle 1193" />
          </div>
        </div>
      </div>
    </div>
